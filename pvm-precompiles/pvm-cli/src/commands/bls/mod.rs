...
pub fn handle(action: BlsCommands) {
    match action {
        ...
        BlsCommands::G1MsmTestData { pairs, output } => msm::cmd_g1_msm_testdata(pairs, output),
        BlsCommands::G2MsmTestData { pairs, output } => msm::cmd_g2_msm_testdata(pairs, output),
